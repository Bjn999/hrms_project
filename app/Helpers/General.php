...
// function get_cols_where_p($model, $columns_name=array(), $where=array(), $order_by="id", $order_type="DESC", $pagination_counter=13) {
//     $data = $model::select($columns_name)->where($where)->orderby($order_by, $order_type)->paginate($pagination_counter);
//     return $data;
// }
